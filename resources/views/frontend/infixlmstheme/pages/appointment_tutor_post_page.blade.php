...
@section('title')
    {{ Settings('site_title') ? Settings('site_title') : 'Metamorphosis LMS' }} | {{ __('appointment.Post Request') }}
@endsection
@section('css')

    <link rel="stylesheet"
          href="{{ asset('Modules\Appointment\Resources\assets\frontend\css\jquery-ui.min.css') }}{{assetVersion()}}"/>
    <style>
