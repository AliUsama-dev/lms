...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'Metamorphosis LMS'}} | {{__('assignment.Assignment')}}
@endsection
@section('css')
    <link href="{{asset('public/backend/css/summernote-bs5.min.css/')}}" rel="stylesheet">
