...
<head>
    ...
    <link rel="icon" href="{{ asset('public/uploads/settings/favicon.png') }}{{ assetVersion() }}" type="image/png"/>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/uploads/settings/favicon.png') }}">
