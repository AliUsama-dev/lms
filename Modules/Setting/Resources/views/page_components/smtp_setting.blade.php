<div class="tab-pane fade white-box mt-20" id="SMTP" role="tabpanel" aria-labelledby="SMTP-tab">
    <!-- SMTP form  -->
            ...
            <div class="col-xl-12">
                <div class="primary_input">
                    ...
                    <select class="primary_select mb-25" name="mail_protocol" onchange="smtp_form()" id="mail_mailer">
                        <option value="smtp" @if (Settings('mail_protocol')  == "smtp") selected @endif>SMTP</option>
                        <option value="sendmail" @if (Settings('mail_protocol')  == "sendmail") selected @endif>Send
                            Mail
                        </option>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="primary_input mb-25">
                    ...
                    <textarea name="mail_signature" class="primary_textarea height_128"
                              placeholder="">{{ Settings('mail_signature')  }}</textarea>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="primary_input mb-25">
                    ...
                    <textarea name="mail_header" class="primary_textarea"
                              placeholder="{company_name}{address}{city} {state}{country_code} {zip_code}{vat_number_with_label}">{{ Settings('mail_header') }}
                    </textarea>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="primary_input mb-25">
                    ...
                    <textarea name="mail_footer" class="primary_textarea" placeholder="{company_name}
                        ...
                        {state}{country_code}
                        {zip_code}
                        {vat_number_with_label}">{{ Settings('mail_footer') }}
                    </textarea>
                </div>
            </div>
            ...
            <div class="col-12 mb-45 pt_15">
                <div class="submit_btn text-center">
                    <button class="primary-btn fix-gr-bg" type="submit"><i class="ti-check"></i> {{ __('common.Save') }}
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label"
                       for="">{{ __('setting.Send a Test Email to') }} {{ env('MAIL_USERNAME') }}</label>
                <div class="email_test">
                    <input class="primary_input_field" placeholder="-" type="text" name="content" required>
                    <button class="primary-btn small fix-gr-bg" type="submit">{{ __('setting.Send Test Mail') }}</button>
                </div>
